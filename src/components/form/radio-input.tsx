...
export const RadioInput = forwardRef(function RadioInput(
  ...
  return (
    <div
      ...
      className="px-2 py-4 w-full flex items-center gap-3 bg-base-button text-base-text uppercase text-xxs rounded-md border border-tranparent data-[state=true]:bg-purple-100 data-[state=true]:border-purple-900"
    >
